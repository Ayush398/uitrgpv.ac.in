...
{ 
  ...
  var docprint=window.open("","",disp_setting); 
   ...
   docprint.document.write('<html><head><title>"University Institute of Technology,RGPV Bhopal"</title>'); 
      ...
      docprint.document.write('<link href="../UIT_style.css" rel="stylesheet" type="text/css" />'); 
       docprint.document.write('<link href="../CSS/ECS.css" rel="stylesheet" type="text/css" />');
        docprint.document.write('<link href="../CSS/SGSITS.css" rel="stylesheet" type="text/css" />');  
